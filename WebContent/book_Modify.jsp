...
function check(form){
	...
	if(form.page.value==""){
		alert("请输入图书页数！");form.price.focus();return false;
	}
	if(!/^\d+$/.test(form.page.value)){
		alert("图书页数为整数，请重新输入！");form.price.focus();return false;
	}
	if(form.price.value>200||form.price.value<5){
		alert("该图书馆没有小于5元或者高于200元的图书!");form.price.focus();return false;
	}if(form.page.value<1){
		alert("页数不能为负！");form.price.focus();return false;
	}
	if(form.page.value>500&&form.page.value<1500){	
		if(confirm("请核对页码是否正确?正确请点击“确定”，重新输入请点击“取消”。")){
			alert("图书信息将保存！");form.price.focus();return true;
		}else{
			alert("请重新输入页数！");form.price.focus();return false;
		}
	}
	if(form.page.value>1500){
		alert("本图书馆无法收容超过1500页的书籍！");form.price.focus();return false;
	}
}
</script>
<head>
...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td valign="top" bgcolor="#9999CC"><table width="99%" height="510"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tableBorder_gray">
  <tr>
	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        ...
        <td width="427" height="39">
          <input name="barcode" type="text" id="barcode" value="<%=barcode%>"  readonly="yes" style= "background-color:transparent;border:0;"></td>
      </tr>
      <tr>
        <td align="center">图书名称：</td>
        <td height="39"><input name="bookName" type="text" id="bookName" value="<%=bookname%>" size="60"  readonly="yes" style= "background-color:transparent;border:0;"></td>
      </tr>
      <tr>
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="author" type="text" id="author" value="<%=author%>"  readonly="yes" style= "background-color:transparent;border:0;"></td>
      </tr>
      <tr>
        <td align="center">译者：</td>
        <td><input name="translator" type="text" id="translator" value="<%=translator%>"  readonly="yes" style= "background-color:transparent;border:0;"></td>
      </tr>
      <tr>
        <td align="center">出版社：</td>
        <td><select name="isbn" class="wenbenkuang"  readonly="yes" style= "background-color:transparent;border:0;">
<%
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="price" type="text" id="price" value="<%=price%>"  readonly="yes" style= "background-color:transparent;border:0;"> 
          (元) * </td>
      </tr>
      <tr>
        <td align="center">页码：</td>
        <td><input name="page" type="text" id="page" value="<%=pages%>"  readonly="yes" style= "background-color:transparent;border:0;"></td>
      </tr>
      <tr>
