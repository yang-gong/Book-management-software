...
<link href="CSS/style.css" rel="stylesheet">
		...
		function checkreader(form){
			...
			{
			alert("请输入正确的读者条形码!");form.barcode.focus();return false;
			}
			form.submit();
		}
		function checkbook(form){
			...
			if(form.inputkey.value.length!=13&&/^\d+$/.test(form.inputkey.value)){
				alert("请输入正确的图书条形码!");form.inputkey.focus();return;
			}
...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td valign="top" bgcolor="#9999CC"><table width="100%" height="509"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tableBorder_gray">
  <tr>
  ...
  <tr>
	...
	<form name="form1" method="post" action="borrow.do?action=bookborrow">
      <tr>
        <td height="42" background="Images/borrowBackRenew.png">&nbsp;</td>
      </tr>
      <tr>
        <td height="72" align="center" valign="top" background="Images/main_booksort_1.gif" bgcolor="#9999CC"><table width="96%" border="0" cellpadding="1" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#f08080">
          <tr>
...
%>
               ...
               <tr>
                 <td height="32" background="Images/borrow_if.png">&nbsp;添加的依据：
                   <input name="f" type="radio" class="noborder" value="barcode" checked>
                   图书条形码 &nbsp;&nbsp;
                   <input name="f" type="radio" class="noborder" value="bookname" >
图书名称&nbsp;&nbsp;
<input name="inputkey" type="text" id="inputkey" size="50" onkeydown="javascript:if(event.keyCode==13) checkbook(form1);">
  ...
  <input name="Button" type="button" class="btn_grey" value="完成借阅" onClick="window.location.href='bookBorrow.jsp'">
          ...
          <tr>
            <td valign="top" bgcolor="#9999CC" style="padding:5px"><table width="99%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#F6B83B" bgcolor="#FFFFFF">
