...
%>
  ...
  <tr>
    <td>
      <a href="#" onClick="window.open('manager_add.jsp','','width=500,height=450')">添加管理员信息</a> </td>
  </tr>
</table>
 <%
}else{
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="84%">&nbsp;      </td>
<td width="16%">
      <a href="#" onClick="window.open('manager_add.jsp','','width=450,height=400')">添加管理员信息</a> </td>	  
  </tr>
</table>  
  ...
  <tr align="center" bgcolor="#9999CC">
    <td width="26%" bgcolor="#9999CC">管理员名称</td>
    <td width="12%" bgcolor="#9999CC">系统设置</td>
    <td width="12%" bgcolor="#9999CC">读者管理</td>
    <td width="12%" bgcolor="#9999CC">图书管理</td>
    <td width="11%" bgcolor="#9999CC">图书借还</td>
    <td width="10%" bgcolor="#9999CC">系统查询</td>
    <td width="9%" bgcolor="#9999CC">权限设置</td>
    <td width="8%" bgcolor="#9999CC">删除</td>
  </tr>
<%
  while(it.hasNext()){
  ...
  <tr>
    ...
    <td align="center"><%if(!name.equals("tsoft")){ %><a href="#" onClick="window.open('manager.do?action=managerModifyQuery&id=<%=ID%>','','width=450,height=400')">权限设置</a><%}else{%>&nbsp;<%}%></td>
    <td align="center">
	<%if(!name.equals("tsoft")){ %><a href="manager.do?action=managerDel&id=<%=ID%>" style="color:#CC3333">删除</a><%}else{%>&nbsp;<%}%></td>
  </tr>
<%
  }
}
