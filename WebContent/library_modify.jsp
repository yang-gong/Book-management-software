...
%>
  ...
  <tr align="center">
    ...
    <td width="80%" align="left">
      <input name="libraryname" type="text" id="libraryname" value="<%=libraryname%>"  readonly="yes" style= "background-color:transparent;border:0;" size="30">
    ...
    <tr>
      ...
      <td align="left"><input name="address" type="text" id="address" size="30" readonly="yes" value="<%=address%>"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left"><input name="createDate" type="text" id="createDate" size="30" readonly="yes" style= "background-color:transparent;border:0;" value="<%=createTime%>">
     </td>
    </tr>
    <tr>
