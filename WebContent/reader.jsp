...
<td width="13%">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    ...
    <td width="10%" bgcolor="#9999CC">姓名</td>
    <td width="8%" bgcolor="#9999CC">读者类型</td>
    <td width="12%" bgcolor="#9999CC">证件类型</td>
    <td width="20%" bgcolor="#9999CC">证件号码</td>
    <td width="12%" bgcolor="#9999CC">电话</td>
    <td width="15%" bgcolor="#9999CC">Email</td>
    <td width="5%" bgcolor="#9999CC">修改</td>
...
<%
  ...
  <tr>
    ...
    <td align="center"><a href="reader.do?action=readerDel&ID=<%=ID%>" style="color:#CC3333">删除</a></td>
  </tr>
<%
  }
}
