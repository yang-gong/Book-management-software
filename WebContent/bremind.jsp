...
%>
  ...
  <tr align="center" bgcolor="#9999CC">
    <td width="15%" bgcolor="#9999CC">图书条形码</td>
    <td width="28%" bgcolor="#9999CC">图书名称</td>
    <td width="17%" bgcolor="#9999CC">读者条形码</td>
    <td width="9%" bgcolor="#9999CC">读者名称</td>
    <td width="15%" bgcolor="#9999CC">借阅时间</td>
    <td width="16%" bgcolor="#9999CC">应还时间</td>
    </tr>
<%
  while(it.hasNext()){
