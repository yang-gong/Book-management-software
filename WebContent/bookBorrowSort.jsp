...
%>
  ...
  %>
 <table width="98%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#B7B6B6" bordercolorlight="#FFFFFF">
  <tr align="center" bgcolor="#9999CC">
  <td width="8%" bgcolor="#9999CC">借阅次数</td>
    <td width="11%" bgcolor="#9999CC">图书条形码</td>
    <td width="17%" bgcolor="#9999CC">图书名称</td>
    <td width="15%" bgcolor="#9999CC">图书类型</td>
    <td width="16%" bgcolor="#9999CC">书架</td>
    <td width="14%" bgcolor="#9999CC">出版社</td>
    <td width="11%" bgcolor="#9999CC">作者</td>
    <td colspan="2" bgcolor="#9999CC">定价(元)</td>
    </tr>
<%
  while(it.hasNext()){
