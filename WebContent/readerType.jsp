...
%>
 ...
 <table width="91%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="91%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#9999CC" bordercolorlight="#FFFFFF">
  <tr align="center" bgcolor="#9999CC">
    <td width="35%" bgcolor="#9999CC">读者类型名称</td>
    <td width="35%" bgcolor="#9999CC">可借数量</td>
    <td width="16%" bgcolor="#9999CC">修改</td>
    <td width="14%" bgcolor="#9999CC">删除</td>
  </tr>
<%
  while(it.hasNext()){
  ...
  <tr>
    ...
    <td align="center"><a href="readerType.do?action=readerTypeDel&ID=<%=ID%>" style="color:#CC3333">删除</a></td>
  </tr>
<%
  }
}
