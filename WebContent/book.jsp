...
<td width="13%">
  ...
  <table width="98%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#9999CC" bordercolordark="#F6B83B" bordercolorlight="#9999CC">
  <tr align="center" bgcolor="#e3F4F7">
    <td width="13%" bgcolor="#9999CC">条形码</td>  
    <td width="26%" bgcolor="#9999CC">图书名称</td>
    <td width="15%" bgcolor="#9999CC">图书类型</td>
    <td width="14%" bgcolor="#9999CC">出版社</td>
    <td width="12%" bgcolor="#9999CC">书架</td>
    <td width="9%" bgcolor="#9999CC">修改</td>
    <td width="5%" bgcolor="#9999CC">删除</td>
  </tr>
<%
  while(it.hasNext()){
  ...
  <tr>
    ...
    <td align="center"><a href="book.do?action=bookDel&ID=<%=ID%>" style="color:#CC3333">删除</a></td>
  </tr>
<%
  }
}
