...
<td width="18%" align="right">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="35%" bgcolor="#9999CC">图书类型名称</td>
    <td width="35%" bgcolor="#9999CC">可借天数</td>
...
<%
  ...
  <tr>
    ...
    <td align="center"><a href="bookType.do?action=bookTypeDel&ID=<%=ID%>" style="color:#CC3333">删除</a></td>
  </tr>
<%
  }
}
