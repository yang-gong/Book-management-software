...
%>
  ...
  <tr align="center" bgcolor="#9999CC">
    <td width="17%" bgcolor="#9999CC">条形码</td>  
    <td width="31%" bgcolor="#9999CC">图书名称</td>
    <td width="18%" bgcolor="#9999CC">图书类型</td>
    <td width="19%" bgcolor="#9999CC">出版社</td>
    <td width="15%" bgcolor="#9999CC">书架</td>
    </tr>
<%
  while(it.hasNext()){
