 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="center">
    ...
    <td width="73%" align="left">
      <input name="name" type="text" id="name" value="<%=chStr.toChinese(managerForm.getName())%>" size="30" disabled="disabled" readonly="yes" style= "background-color:transparent;border:0;">    </td>
    <tr>
    <td align="left" style="padding:5px;">原密码：</td>
    <td align="left"><input name="oldpwd" type="password" id="oldpwd" size="30" onkeyup="this.value=this.value.replace(/[^\w_]/g,'');" data-errormessage="密码长度最少8位,字母+数字+_"
                        placeholder="密码长度最少8位,字母+数字+_" >
    ...
    <tr>
      ...
      <td align="left"><input name="pwd" type="password" id="pwd" size="30" onkeyup="this.value=this.value.replace(/[^\w_]/g,'');" data-errormessage="密码长度最少8位,字母+数字+_"
                        placeholder="密码长度最少8位,字母+数字+_" ></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;">确认新密码：</td>
      <td align="left"><input name="pwd1" type="password" id="pwd1" size="30" onkeyup="this.value=this.value.replace(/[^\w_]/g,'');" data-errormessage="密码长度最少8位,字母+数字+_"
                        placeholder="密码长度最少8位,字母+数字+_" ></td>
    </tr>
    <tr>
