...
<table width="778"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#9999CC">
      <tr bgcolor="#9999CC">
        ...
        <td width="66%" align="right" bgcolor="#9999CC" class="word_white"><a href="main.jsp" class="word_white">首页</a> |
         ...
         <%}%><%if(readerset1==1){%><a  onmouseover=showmenu(event,readermenu) onmouseout=delayhidemenu() style="CURSOR:hand"  class="word_white">读者管理</a> |
          <%}%><%if(bookset1==1){%><a  onmouseover=showmenu(event,bookmenu) onmouseout=delayhidemenu() class="word_white" style="CURSOR:hand" >图书管理</a> |
           ...
           <%}%><%if(sysquery1==1){%><a  onmouseover=showmenu(event,querymenu) onmouseout=delayhidemenu()  class="word_white" style="CURSOR:hand" >系统查询</a> |
            <%}%><a  href="manager.do?action=querypwd" class="word_white">更改口令</a> | <a href="#" onClick="quit()" class="word_white" style="color:#CC3333">退出系统</a></td>
        <td width="2%" bgcolor="#9999CC">&nbsp;</td>
  </tr>
      <tr bgcolor="#9999CC">
