...
function check(form){
	...
	{
	alert("您输入的开始日期不正确（如：2006-07-05）， 请注意闰年!");form.barcode.focus();return false;
	}
	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        ...
        <td width="427" height="39">
          <input name="name" type="text" value="<%=name%>"  readonly="yes" style= "background-color:transparent;border:0;"> 
      ...
      <tr>
        ...
        <td><input name="barcode" type="text" id="barcode" value="<%=barcode%>"  readonly="yes" style= "background-color:transparent;border:0;"></td>
      </tr>
      <tr>
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="operator" type="text" id="operator" value="<%=operator%>" readonly="yes" style= "background-color:transparent;border:0;">
        </td>
      </tr>
      <tr>
